...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden text-gray-900 h-screen flex items-center justify-center">
      <div className="absolute inset-0 z-[-1]">
        <div className="absolute left-[calc(50%-11rem)] top-[-40%] transform-gpu overflow-hidden blur-3xl sm:left-[calc(50%-30rem)] sm:-top-80">
          <div
            className="relative aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#56a75c] to-[#c8dfca] opacity-80 sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="absolute left-[calc(50%+3rem)] top-[calc(100%-13rem)] transform-gpu overflow-hidden blur-3xl sm:left-[calc(50%+36rem)] sm:top-[calc(100%-30rem)]">
          <div
            className="relative aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#5ca562] to-[#c8dfca] opacity-80 sm:w-[72.1875rem]"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
        ...
        <div className="absolute left-[calc(50%+10rem)] top-[calc(50%-8rem)] transform-gpu overflow-hidden blur-3xl sm:left-[calc(50%+20rem)] sm:top-[calc(50%-20rem)]">
          <div
            className="relative aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#74ca7b] to-[#c8dfca] opacity-80 sm:w-[72.1875rem]"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
        ...
        <div className="absolute left-[calc(50%-8rem)] top-[calc(75%-6rem)] transform-gpu overflow-hidden blur-3xl sm:left-[calc(50%-15rem)] sm:top-[calc(75%-15rem)]">
          <div
            className="relative aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[15deg] bg-gradient-to-tr from-[#a5ffad] to-[#c8dfca] opacity-80 sm:w-[72.1875rem]"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
      ...
      <div
        className={`flex justify-center absolute bottom-40 lg:bottom-14 left-1/2 transform -translate-x-1/2 p-2 rounded-3xl bg-gray-900 hover:cursor-pointer ease-in-out duration-300 ${
